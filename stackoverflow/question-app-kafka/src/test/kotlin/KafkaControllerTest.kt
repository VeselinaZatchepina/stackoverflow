...
class KafkaControllerTest {
    ...
    fun runKafka() {
        ...
        consumer.schedulePollTask {
            ...
            consumer.addRecord(
                ConsumerRecord(
                    ...
                    0L,
                    "test-1",
                    apiV1RequestSerialize(CreateQuestionRequest(
        ...
        val result = apiV1ResponseDeserialize<CreateQuestionResponse>(message.value())
        assertEquals(outputTopic, message.topic())
        assertEquals("11111111-1111-1111-1111-111111111111", result.requestId)
        assertEquals("Some Ad", result.createdQuestion?.title)
    }
