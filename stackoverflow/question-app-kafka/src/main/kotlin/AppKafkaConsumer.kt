...
interface ConsumerStrategy {
    ...
    fun serialize(source: SContext): String
    fun deserialize(value: String, target: SContext)
}
...
class AppKafkaConsumer(
    ...
    private val service: QuestionService = QuestionService(settings = settings),
    ...
    private fun sendResponse(context: SContext, strategy: ConsumerStrategy, outputTopic: String) {
